        ...
        <section class="eventadd p-event-right-content">
            <div class=""> 
                <div class="eventadd-parent alert c-bgcolor--beige c-text-lg c-color" role="alert">
                    ...
                    <div class="obj-cover"><a href="/user1/{{$item->user->id}}"><img src="{{asset('/storage/userimg/'.$item->getUserIcon())}}" class="" alt="..." width="100%" height="100%"></a></div>
            ...
            <div class="eventadd__content">
                ...
                <div class="eventadd__left ">
                    ...
                    {{--  guestテーブルにuser_idがあるかどうかを判断して参加・辞退を表示  --}}
