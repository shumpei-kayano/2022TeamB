                        ...
                        <div class="d-flex">
                          ...
                          <div class="p-blog_edit_area__open_chat_list_title">      
                            ...
                            <div class="p-blog_edit_area__blog_text_small">
                              {{-- DBから記事本文データを取得／DBから装飾タグ含めて70文字まで表示(※※※※※※70文字以上だとページレイアウト崩れるので変更しない※※※※※※)--}}
                              {{-- <a href="/blog_show/{{$datas->id}}" style="text-decoration: none; color:black;">{!! nl2br(Str::limit($datas->text, 70)) !!} </a> --}}
